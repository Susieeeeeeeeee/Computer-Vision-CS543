...
# referencing #https://discuss.pytorch.org/t/confused-about-the-image-preprocessing-in-classification/3965
# ---------------------
...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.fc_net = nn.Sequential(
            nn.Linear(128 * fc_ksize * fc_ksize, 1024),
            nn.Linear(1024, 512),
            nn.BatchNorm1d(512),
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 128 * fc_ksize * fc_ksize)
...
with open('submission_siyub2.csv', 'w') as csvfile:
